                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _TimeControlPicker(
                        ...
                        minutesController: _customMinutesController,
                        onChanged: (tc) =>
...
class _TimeControlPicker extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isCustomActive = !selected.isUntimed &&
        ![3, 5, 10, 15].contains(selected.minutes);
    return Column(
      children: [
        Wrap(
          ...
          children: [
            _timeChip(
              label: 'Untimed',
              isSelected: selected.isUntimed,
              onTap: () => onChanged(const TimeControl.untimed()),
            ),
            for (final m in [3, 5, 10, 15])
              _timeChip(
                label: '$m min',
                isSelected: !selected.isUntimed && selected.minutes == m,
                onTap: () => onChanged(TimeControl.minutes(m)),
              ),
            _timeChip(
              label: 'Custom',
              isSelected: isCustomActive,
              onTap: () {
                final parsed = int.tryParse(minutesController.text);
                onChanged(TimeControl.minutes(parsed != null && parsed > 0 ? parsed : 10));
              },
            ),
          ],
        ),
            ...
            child: TextField(
              ...
              onChanged: (text) {
                ...
                if (parsed != null && parsed > 0) {
                  onChanged(TimeControl.minutes(parsed));
                }
              },
            ),
          ),
