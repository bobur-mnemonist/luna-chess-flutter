...
// swapped based on game state, each animated with a subtle breathing scale
// and an irregular blink (vertical squash) so the still image reads as
// alive rather than a static photo.
...
class _LunaPanelState extends State<LunaPanel> with TickerProviderStateMixin {
  ...
  String _imageForMood() {
    switch (widget.mood) {
      case 'happy':
        return 'assets/images/luna_happy.png';
      case 'worried':
        return 'assets/images/luna_worried.png';
      case 'thinking':
        return 'assets/images/luna_thinking.png';
      default:
        return 'assets/images/luna_idle.png';
    }
  }
