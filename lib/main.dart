...
class _ChessBoardScreenState extends State<ChessBoardScreen> {
  ...
  void _playMoveSound() {
    if (!soundOn) return;
    // Plays a short bundled "tick" sound via audioplayers, which works
    // reliably even when the system click sound (SystemSound) is silenced
    // by notification/media volume settings on some devices.
    _audioPlayer.play(AssetSource('audio/move_tick.wav'));
  }
