...
class _ChessBoardScreenState extends State<ChessBoardScreen> {
  ...
  String? userName;
  // Free tier gets Luna's commentary for the first 10 lines of each game,
  // then she goes quiet for the rest of that game (resets fresh on
  // Restart/a new game) unless the player is premium. Puzzles/Memory
  ...
  // calling _pickLine directly, so the free-tier per-game line limit is
  // enforced in one place rather than needing a check at every call site.
  // Once the free lines run out for this game, Luna goes quiet (bubble
  // shows a small "Premium" upsell) rather than silently keeping the old
  // last-shown line on screen.
