...
// A quiet tick sound for scroll-wheel pickers (Difficulty, Time), reusing
// the existing move sound asset at low volume rather than bundling a
// dedicated click sound — kept as a fire-and-forget disposable player
// like _playMoveSound, so rapid scrolling doesn't leak AudioPlayer
// instances.
void _playWheelTick() {
  final player = AudioPlayer();
  player.setReleaseMode(ReleaseMode.release);
  player.onPlayerComplete.listen((_) => player.dispose());
  player.play(AssetSource('audio/move-2.wav', mimeType: 'audio/wav'), volume: 0.4);
}
